(function (global, factory) {
	...
	function OrbitControls ( object, domElement ) {
	    ...
	    this.autoRotateDirection = 'left'; // left, right
	    ...
	    this.update = function ( ignoreUpdate ) {
	        ...
	        if ( this.autoRotate && state === STATE.NONE ) {
	        	...
	        	if (this.autoRotateDirection == 'left') {
	...
	function Viewer ( options ) {
	    ...
	    options.autoRotateDirection = options.autoRotateDirection || 'left';
	    ...
	    this.OrbitControls.autoRotateDirection = this.options.autoRotateDirection;
